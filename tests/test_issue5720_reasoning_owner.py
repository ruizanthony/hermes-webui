...
eval(anchorsSrc);
for(const name of [
  'chatActivityMode','chatActivityLiveMode','chatActivitySettledMode','isTransparentLiveMode','isTransparentStream','isFinalAnswerOnlyMode','isCompactWorklogMode','isSimplifiedToolCalling',
